    ...
    <section id="about" className="section experience-section navy-section section-space">
      <div className="shell experience-grid">
        <div className="experience-left" data-reveal>
          ...
          <div className="experience-image" data-image-reveal><Image src="/images/brand/international-sales.webp" alt="Timber logistics and warehousing" fill sizes="(max-width: 500px) 100vw, 48vw" /></div>
        </div>
